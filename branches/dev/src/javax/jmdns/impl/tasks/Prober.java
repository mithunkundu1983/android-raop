...
public class Prober extends TimerTask
{
    ...
    public Prober(JmDNSImpl jmDNSImpl)
    {
        ...
        {
            for (Iterator<ServiceInfo> iterator = this.jmDNSImpl.getServices().values().iterator(); iterator.hasNext();)
            {
    ...
    public boolean cancel()
    {
        ...
        synchronized (this.jmDNSImpl)
        {
            for (Iterator<ServiceInfo> i = this.jmDNSImpl.getServices().values().iterator(); i.hasNext();)
            {
    ...
    public void run()
    {
        synchronized (this.jmDNSImpl.getIoLock())
        {
            ...
            try
            {
                ...
                synchronized (this.jmDNSImpl)
                {
                    list = new LinkedList<ServiceInfo>(this.jmDNSImpl.getServices().values());
                }
