...
public class Responder extends TimerTask
{
    ...
    public final static String TAG = Responder.class.toString();
    ...
    public void run()
    {
        synchronized (this.jmDNSImpl.getIoLock())
        {
            ...
            HashSet<DNSEntry> answers = new HashSet<DNSEntry>();
                                ...
                                case DNSConstants.TYPE_A:
                                    {
                                        ...
                                        DNSRecord answer = this.jmDNSImpl.getLocalHost().getDNS4AddressRecord();
//                                        Log.d(TAG, String.format("trying to answer TYPE_A with answer=%s", answer.toString()));
                                        if (answer != null)
                                        {
                                            answers.add(answer);
                                        }
                                ...
                                case DNSConstants.TYPE_PTR:
                                    {
                                        ...
                                        for (Iterator<ServiceInfo> serviceIterator = this.jmDNSImpl.getServices().values().iterator(); serviceIterator.hasNext();)
                                        {
                    ...
                    if (answers.size() != 0)
                    {
                        ...
                        for (Iterator<DNSEntry> i = answers.iterator(); i.hasNext();)
                        {
