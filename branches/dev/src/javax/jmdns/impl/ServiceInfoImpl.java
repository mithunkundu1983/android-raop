...
public class ServiceInfoImpl extends ServiceInfo implements DNSListener
{
    ...
    {
        Hashtable<String, byte[]> props = getProperties();
    ...
    synchronized Hashtable<String, byte[]> getProperties()
    {
...
//        	out.addAuthorativeAnswer(new DNSRecord.Address(getQualifiedName(), DNSConstants.TYPE_A, DNSConstants.CLASS_IN, ttl, localHost.getAddress()));
//        }
    }
